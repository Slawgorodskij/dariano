...
const renderStringMyOrder = (item) => {
    return `<tr class="table__string">
        ...
        <td class="table__cell table__cell_border table__cell_client">${item.client}</td>
        <td class="table__cell table__cell_border table__cell_nowrap">${item.phone}</td>
        <td class="table__cell table__cell_border table__cell_address">${item.address}</td>
        <td class="table__cell table__cell_border table__cell_nowrap">${item.order}</td>
        <td class="table__cell table__cell_border table__cell_nowrap">${item.date}</td>
...
const renderTableMyOrder = (item) => {
    return `<div class="table-mobile__string">
       <div class="table-mobile__row table-mobile-order__row table-mobile-order__befor"> 
          
          <div class="table-mobile-order__cell_size">
            ...
            <p class="table-mobile-order__cell_title ">Выбрать</p>
          </div>
          
          <div class="table-mobile-order__cell_alter">  
            ...
            <p class="table-mobile-order__cell_title">Изменить</p>
          </div>
       </div>
       
            
         <div class="table-mobile__row table-mobile__row_string table-mobile-order__row "> 
        <p class="table-mobile__cell_title table-mobile__cell_w-13">№</p>
...
const renderTable = (list) => {
    ...
    if (document.querySelector('.table-my-order')) {
        ...
        tableOrders.innerHTML = `<tr class="table__string">
            <th class="table__cell table__cell_border table__cell_title table__cell_title_first">№</th>
            <th class="table__cell table__cell_border table__cell_title cell__status">Статус</th>
            <th class="table__cell table__cell_border table__cell_title cell__client">ФИО клиента</th>
            <th class="table__cell table__cell_border table__cell_title cell__phone">Телефон</th>
            <th class="table__cell table__cell_border table__cell_title cell__address">Адрес</th>
            <th class="table__cell table__cell_border table__cell_title cell__order">Сумма заказа</th>
            <th class="table__cell table__cell_border table__cell_title cell__date">Дата</th>
            <th class="table__cell table__cell_border table__cell_title cell__note">Примечание</th>
            <th class="table__cell table__cell_border table__cell_title cell__reserve"></th>
        </tr>`
    }
